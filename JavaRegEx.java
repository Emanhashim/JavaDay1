...
Pattern Class - Defines a pattern (to be used in a search) the keyword or int type to be searched
Matcher Class - Used to search for the pattern (the keys that hold the stmt or of all)
PatternSyntaxException Class - Indicates syntax error in a regular expression pattern
        ...
        public class Main {
          public static void main(String[] args) {
            Pattern pattern = Pattern.compile("morocco", Pattern.CASE_INSENSITIVE);
            Matcher matcher = pattern.matcher("Visit morocco!");
        ...
        Example Explained
In this example, The word "morocco" is being searched for in a sentence.
