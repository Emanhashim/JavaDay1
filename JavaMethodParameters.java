  ...
  1, Parameters and Arguments
    ...
    The following example has a method that takes a String called fname as parameter. When the method is called, we pass along a first name, which is used inside the method to print the full name:
     ...
     e.g
            ...
            ** Note When a parameter is passed to the method, it is called an argument.
        ...
        The void keyword, used in the examples above, indicates that the method should not return a value.
         ...
         e.g
           ...
           e.g 2,
                ...
                this e.g2 show's to put the result in a variable then print the static value
                which is easy to make the code clean


            4, A Method with If...Else
